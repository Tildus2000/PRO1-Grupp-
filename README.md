...
Äldre hus eller källare har ofta inte samma isolering eller värme som resterande hus, det är även vanligt med ökad luftfutkighet i dessa ytor. Temperatur och luftfuktighet har stor inverkarn på hur långtid det tar för väggfärg att torka samt hur den torkar. Exempelivs ytor med högluftfuktighet och läger temperur torkar långsammare, som yrkesamma målare med deadlines vill man att torkniningsproccessen ska gå så snabbt som möjligt samt att resulatet ska bli så bra som möjligt.
Genom en DHT11 sensaor kan de få viktigt infromation som avögr hur de ska göra för att uppnå bästa resultat samt tideffektivas och om de exemeplivs behöver ha med sig ventelationssytem, element eller likande för att göra miljön så optimal som möjligt.

En väggfärg från Alcro som är ett vanligt märke inom målarbranchen fungerar optimalt i 23garder och 50% luftfuktighet och är då klibbfri inom 50 minuter och övermålningsbar inom 2 timmar. 
